                            ...
                            <form action="{{ route('question.update',$question->id) }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{$question->title}}" name="title" id="input-name"
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea name="answers" value="{{$question->answers}}"  class="form-control" id="exampleFormControlTextarea1"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="quizze_id">
                                                <option selected value="{{$question->quiz_id}}" disabled>{{$question->quiz->name}}</option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="score">
                                                <option selected disabled>  {{$question->score}}...</option>
